---
name: openclaw-guidelines
description: Best practices for maintaining multiple AI agents with OpenClaw — lean workspaces, skill-first architecture, memory continuity, config/docs verification, and agent coherence. Use when configuring agents, editing workspace files, managing memory, debugging OpenClaw issues, or making changes across multiple agents.
license: MIT
---
